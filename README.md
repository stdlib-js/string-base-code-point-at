...
```javascript
codePointAt = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-code-point-at@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/string-base-code-point-at/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/string-base-code-point-at/actions/workflows/test.yml?query=branch:v0.2.1
